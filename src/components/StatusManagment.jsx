    ...
    <tr className="border-t-2 border-b-2" key={index}>
      ...
      <td>
        <div className="flex gap-3 text-[18px]">
          <span className='cursor-pointer hover:text-blue-600'><i className="ri-chat-1-line"></i></span>
          <span className='cursor-pointer hover:text-blue-600'><i className="ri-phone-line"></i></span>
       <Link to={`/editprofile/${member.email}`}>  <span className='cursor-pointer hover:text-blue-600'> <i class="ri-edit-2-line"></i></span> </Link>   
          <span className='cursor-pointer hover:text-blue-600' onClick={()=>deleteMember(member.email)}> <i className="ri-delete-bin-7-line"></i></span>
        </div>
      </td>
    </tr>
  ))
