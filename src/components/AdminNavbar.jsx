  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Welcome to Admin Dashboard</h2>
        <div className="flex p-10 justify-center space-x-4">
          <Link to='/managecredentials'>
            <div className="flex items-center cursor-pointer justify-center p-4 w-40 h-40 rounded-xl bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 shadow-lg transition duration-300">
              <div className="text-center flex flex-col gap-2 items-center justify-center">
                <FaBriefcase size={40} className="text-white" />
                <p className="text-white font-bold mt-2">Manage Portal</p>
              </div>
            </div>
          </Link>  
          <Link to='/displaysubadmin'>
            <div className="flex items-center cursor-pointer justify-center p-4 w-40 h-40 rounded-xl bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 shadow-lg transition duration-300">
              <div className="text-center flex flex-col gap-2 items-center justify-center">
                <FaBriefcase size={40} className="text-white" />
                <p className="text-white font-bold mt-2">Manage Subadmin</p>
              </div>
            </div>
          </Link>  
